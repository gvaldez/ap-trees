# 📁 ARCHIVO LEGACY - ESPECIFICACIÓN DEL SISTEMA

> **Nota Importante**: Este es el archivo de especificación consolidado original que contiene todo el contenido histórico del sistema. 
> 
> **Para consultar la documentación actualizada y modular**, por favor dirígete a la carpeta `/docs` donde encontrarás la documentación organizada por módulos para facilitar la navegación y edición.
>
> Este archivo se mantiene como referencia histórica y respaldo completo.
